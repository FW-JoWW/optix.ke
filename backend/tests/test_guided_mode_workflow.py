...
from backend.core.guided_versions import diff_guided_stage_snapshots, restore_guided_stage_snapshot
...
from backend.nodes.guided_mode_node import _stage_modification_capability_profile
from backend.scripts.guided_mode_harness import run_guided_workflow, summarize_guided_result
...
def test_guided_mode_natural_language_intent_parsing() -> None:
    from backend.scripts.guided_mode_harness import build_guided_state
...
def _deterministic_reasoning(decision_object: dict[str, Any]) -> tuple[dict[str, Any], list[str], str]:
    import backend.core.reasoning_layer as reasoning_layer_module
