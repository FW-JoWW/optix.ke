...
from backend.collaborative_mode.session_runner import run_interactive_collaborative_session
from backend.collaborative_mode.presentation import render_collaborative_analyst_view, render_debug_collaborative_view
from backend.graph.analyst_graph import graph
from backend.state.state import AnalystState
from backend.utils.openai_runtime import get_openai_runtime_info
from backend.scripts.collaborative_mode_harness import build_guided_sample_dataframe
from backend.scripts.guided_mode_harness import (
...
def main() -> None:
    ...
    if mode == "collaborative":
        dataset_path = "backend/data/olist_merged_dataset.csv"
        ...
        if use_sample_dataset:
            ...
            dataset_path = "backend/data/collaborative_test_dataset.csv"
    ...
    dataset_path = "backend/data/olist_merged_dataset.csv"  # "backend/data/Car Dataset 1945-2020.csv"
    df = load_default_dataframe(dataset_path)
