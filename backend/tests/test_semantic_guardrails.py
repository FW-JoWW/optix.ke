...
from backend.core.insight_validator import validate_insight
from backend.core.recommendation_guard import guard_recommendations
from backend.core.semantic_classifier import classify_relationship
from backend.llm.output_filter import filter_llm_output
from backend.nodes.evidence_interpreter_node import evidence_interpreter_node


def test_unit_conversion_case() -> None:
    df = pd.read_csv("backend/data/Car Dataset 1945-2020.csv", low_memory=False, usecols=["engine_hp", "max_power_kw"])
