...
class AnalystState(TypedDict):
    ...
    reasoning_objects: Optional[List[Dict[str, Any]]]
    reasoning_layer: Optional[Dict[str, Any]]
    reasoning_cache: Optional[Dict[str, Any]]
    guided_version_snapshots: Optional[Dict[str, Any]]
    guided_mode: Optional[Dict[str, Any]]
    guided_decision_log: Optional[List[Dict[str, Any]]]
    guided_checkpoint_versions: Optional[Dict[str, int]]
    guided_visualization_preferences: Optional[Dict[str, Any]]
    collaborative_session: Optional[Dict[str, Any]]
    collaborative_tasks: Optional[List[Dict[str, Any]]]
    collaborative_task_graph: Optional[Dict[str, Any]]
    collaborative_queue: Optional[List[Dict[str, Any]]]
    collaborative_evidence_store: Optional[Dict[str, Any]]
    collaborative_memory: Optional[Dict[str, Any]]
    collaborative_hypotheses: Optional[List[Dict[str, Any]]]
    collaborative_decision_log: Optional[List[Dict[str, Any]]]
    collaborative_progressive_narrative: Optional[List[str]]
    collaborative_suggestions: Optional[List[Dict[str, Any]]]
    collaborative_task_comparisons: Optional[List[Dict[str, Any]]]
    collaborative_final_report: Optional[str]
